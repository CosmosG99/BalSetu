    ...
    <div className="glass-panel p-5 rounded-2xl border border-white/10 space-y-4 shadow-lg">
      <div className="flex items-center justify-between border-b border-slate-800 pb-3">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h4 className="text-xs font-bold text-white uppercase tracking-wider">Simulated Smart Response Routing</h4>
            <p className="text-[11px] text-slate-400">Automated triage matrix matching for transit node</p>
          </div>
        </div>
          ...
          return (
            ...
            >
              <div className="flex items-center space-x-3">
                <div className="p-2 rounded-lg bg-slate-800 text-brand-purple border border-slate-700">
                  <Icon className="w-4 h-4" />
                </div>
                <div>
                  <div className="font-bold text-white">{item.organization}</div>
                  <div className="text-[10px] text-slate-400 font-mono">Category: {item.category}</div>
                </div>
              </div>
