      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-slate-900/90 border border-slate-800 rounded-xl text-xs text-white placeholder-slate-500 focus:outline-none focus:border-brand-purple transition-all"
          />
        </div>
            ...
            <tbody className="divide-y divide-slate-800/60">
              {filteredCases.length === 0 ? (
                ...
                filteredCases.map((c) => (
                  ...
                  >
                    <td className="py-3.5 px-4 font-mono font-bold text-brand-purple group-hover:text-purple-300">
                      {c.id}
                    </td>
                    ...
                    <td className="py-3.5 px-4 text-slate-300">
                      <div className="flex flex-wrap gap-1">
                        {c.report.incidentTypes.map((t) => (
                          <span key={t} className="px-2 py-0.5 rounded bg-slate-800 border border-slate-700 text-[10px] text-slate-300 font-medium">
                            {t}
                          </span>
                        ))}
                      </div>
                    ...
                    <td className="py-3.5 px-4 text-right">
                      <button className="p-1 text-slate-400 group-hover:text-white transition-colors">
