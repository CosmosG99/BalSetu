  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14 space-y-12">
      ...
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <h1 className="text-3xl sm:text-5xl font-extrabold text-white">About Rakshak</h1>
      ...
      <div className="glass-panel p-8 rounded-3xl border border-white/10 space-y-6 shadow-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
          <div className="p-4 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-1">
            ...
            <p className="text-xs text-slate-400">Anonymous by default, zero mandatory personal data collection, automatic face blur simulation on images.</p>
          </div>
          <div className="p-4 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-1">
            <span className="text-xs font-bold text-brand-magenta uppercase">AI Assists • Humans Decide</span>
            <p className="text-xs text-slate-400">AI provides advisory risk triage and explanations without making definitive accusations or legal determinations.</p>
          </div>
        </div>
      </div>

      {/* Prototype Disclaimers */}
      <div className="p-6 rounded-3xl bg-amber-500/10 border border-amber-500/30 text-amber-200 space-y-2 text-xs">
